...
const ShopApplication = () => {
  return (
    ...
    <Navbar/>
    <div>
      <div className="container py-5 rtl" style={{ textAlign: "left" }}>
  <h3 className="mb-3 text-center"> Shop Application</h3>
  <form
    className="__shop-apply"
    action=""
    id="form-id"
    method="post"
  ...
  >
    ...
    />
    <div className="card __card mb-3">
      ...
      <div className="card-body">
        <div className="row g-3">
          ...
          <div className="col-sm-12">
            <center>
              <img
                className="__img-125px object-cover"
                id="viewer"
    ...
    <div className="card __card ">
      ...
      <div className="card-body">
        <div className="row g-3">
            ...
            <div className="form-group">
              <div className="custom-file">
                <input
                  ...
                  name="banner"
                  id="BannerUpload"
                  className="custom-file-input overflow-hidden __p-2p"
          ...
          <div id="recaptcha_element" className="w-100" data-type="image">
            <div style={{ width: 304, height: 78 }}>
              <div>
                <iframe
                  title="reCAPTCHA"
                  src="https://www.google.com/recaptcha/api2/anchor?ar=1&k=6LfMARoeAAAAAAITvA-le6X9IElSWX6CncicwEfY&co=aHR0cHM6Ly82dmFsbGV5LjZhbXRlY2guY29tOjQ0Mw..&hl=en&type=image&v=NZrMWHVy58-S9gVvad9HVGxk&size=normal&cb=c6x5f4dxplq5"
                  width={304}
                  height={78}
                  role="presentation"
                  name="a-r08wlbng3eeo"
          ...
          <br />
          <div className="col-sm-12">
            <div className="form-group mb-0 d-flex flex-wrap justify-content-between">
            ...
            <input type="hidden" name="from_submit" defaultValue="seller" />
            <button
              type="submit"
              className="btn btn--primary w-100 py-2 btn-md btn-user btn-block"
              id="apply"
              disabled=""
            >
              Apply Shop{" "}
