...
<button type="submit" class="btn btn--primary" data-bs-toggle="modal" data-bs-target="#exampleModal" id="add_new_address">Add new address
</button>
</div>
...
>
  ...
  <div className="row">
    <div className="col-md-6">
      <ul className="donate-now d-flex">
        <li>
          <input
            type="radio"
            id="a25"
        ...
        <li>
          <input type="radio" id="a50" name="addressAs" defaultValue="home" />
    ...
    <div className="col-md-6 d-flex">
      <ul className="donate-now">
        ...
        <li>
          <input type="radio" name="is_billing" id="b50" defaultValue={1} />
  ...
  <div className="tab-content" jstcache={0}>
    <div id="home" className="container tab-pane active" jstcache={0}>
      <br />
      <div className="row">
      ...
      <div className="row">
        ...
        <div className="form-group col-md-12">
          <label htmlFor="address-city">Country</label>
